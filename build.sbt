...
lazy val idslpayload = (project in file("idslpayload"))
  .settings(
    ...
    version := SpinalVersion.sim+spinalTmpVersion
  )
...
lazy val core = (project in file("core"))
  ...
  .settings(
    ...
    version := SpinalVersion.core+spinalTmpVersion,
...
lazy val lib = (project in file("lib"))
  .settings(
    ...
    name := "SpinalHDL-lib",
    libraryDependencies += "commons-io" % "commons-io" % "2.4",
    version := SpinalVersion.lib+spinalTmpVersion
  )
  .dependsOn (sim, core)
...
lazy val debugger = (project in file("debugger"))
  .settings(
    ...
    version := SpinalVersion.debugger+spinalTmpVersion,
...
lazy val tester = (project in file("tester"))
  .settings(
    ...
    version := SpinalVersion.tester+spinalTmpVersion,
